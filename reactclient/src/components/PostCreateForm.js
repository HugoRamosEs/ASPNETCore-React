...
export default function PostCreateForm(props) {
    ...
    const initialFormData = Object.freeze({
        title: 'Post X',
        content: 'Este es el Post X, contiene cosas interesantes',
    });
    ...
    return (
        <form className='w-100 px-5'>
            <h1 className='mt-5'>Crea un nuevo post</h1>
            <div className='mt-5'>
            ...
            <button onClick={handleSubmit} className='btn btn-dark btn-lg w-100 mt-5'>Aceptar</button>
